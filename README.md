...
A token is used to authorize access to certain components

- [ ] What steps can you take in your web apps to keep your data secure?

Creating Server-side Authentication, must have needed credenitals in order to access data behind proected components

- [ ] Describe how web servers work.

Web servers hold data and the user requests data from that web server. Given the required information is need if behind protected pages the server then sends back the request and pages.
